...
export const TOOLS: Tool[] = [
  {
    ...
    description: 'Search Belgian statutes and regulations by keyword. Uses FTS5 with BM25 ranking.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'get_provision',
    description: 'Retrieve a specific provision (section) from a Belgian statute.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Validate a Belgian legal citation against the database. Zero-hallucination check.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Build a comprehensive set of citations for a legal question across Belgian statutes.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Format a Belgian legal citation per standard conventions (full, short, or pinpoint).',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'check_currency',
    description: 'Check if a Belgian statute or provision is currently in force.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Statute identifier or title' },
  ...
  {
    name: 'get_eu_basis',
    description: 'Get EU legal basis (directives/regulations) for a Belgian statute or retained EU law.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Belgian statute identifier' },
  ...
  },
  {
    ...
    description: 'Find Belgian statutes implementing a specific EU directive or regulation.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Search for EU directives/regulations with Belgian implementation information.',
    inputSchema: {
      type: 'object',
      properties: {
        ...
        has_belgian_implementation: { type: 'boolean', description: 'Filter by Belgian implementation' },
  ...
  },
  {
    ...
    description: 'Get EU legal basis for a specific provision within a Belgian statute.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Belgian statute identifier' },
  ...
  },
  {
    ...
    description: 'Validate EU compliance status for a Belgian statute or provision.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Belgian statute identifier' },
