/**
 * get_belgian_implementations — Find Belgian statutes implementing an EU directive/regulation.
 */

import type { Database } from '@ansvar/mcp-sqlite';
import { generateResponseMetadata, type ToolResponse } from '../utils/metadata.js';

export interface GetBelgianImplementationsInput {
  eu_document_id: string;
  primary_only?: boolean;
  in_force_only?: boolean;
}

export interface GetBelgianImplementationsResult {
  eu_document_id: string;
  eu_title?: string;
...
export async function getBelgianImplementations(
  db: Database,
  input: GetBelgianImplementationsInput
): Promise<ToolResponse<GetBelgianImplementationsResult>> {
